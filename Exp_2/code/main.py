# Originally download from: https://github.com/pytorch/examples/blob/main/imagenet/main.py
# tensorboard --logdir=D:\Codefield\DLP\Slides\L10\exp10\runs2
import argparse
import os
import random
import shutil
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    t1 = time.time()
    elapsed_rounded = int(round((t1-t0)))
    print("Time cost:",str(datetime.timedelta(seconds=elapsed_rounded)))
...
def validate(val_loader, model, criterion, args, epoch):
    ...
    writer.add_scalar('Val_acc5',top5.avg,epoch)
